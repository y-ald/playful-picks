    ...
    <div className="min-h-screen bg-white pt-24">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto py-16">
          <h1 className="text-4xl font-bold mb-8">{t.title || 'About Kaïa Kids'}</h1>
