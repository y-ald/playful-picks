    ...
    <footer className="bg-ink text-background mt-20">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <p className="text-[11px] tracking-[0.3em] uppercase text-background/60 mb-3">
                {n.eyebrow || 'Stay in the loop'}
              </p>
              <h3 className="font-display text-3xl lg:text-5xl font-light text-balance leading-[1.05]">
                {n.title1 || 'Letters from'} <span className="italic">{n.title2 || 'the studio.'}</span>
              </h3>
            </div>
            <form
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            <h5 className="text-[11px] tracking-[0.3em] uppercase text-background/40 mb-5">{t.shop || 'Shop'}</h5>
            <ul className="space-y-3 text-sm">
              <li><Link to={`/${lang}/shop`} className="text-background/80 hover:text-background transition-colors">{t.allProducts || 'All products'}</Link></li>
              <li><Link to={`/${lang}/shop`} className="text-background/80 hover:text-background transition-colors">{t.newArrivals || 'New arrivals'}</Link></li>
              <li><Link to={`/${lang}/favorites`} className="text-background/80 hover:text-background transition-colors">{t.favorites || 'Favorites'}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to={`/${lang}/about`} className="text-background/80 hover:text-background transition-colors">{t.about || 'About'}</Link></li>
          ...
          <div>
            <h5 className="text-[11px] tracking-[0.3em] uppercase text-background/40 mb-5">{t.connect || 'Connect'}</h5>
